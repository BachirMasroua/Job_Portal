  ...
  return (
    <div className="bg-custom-white">
      <div className="bg-gradient-to-r lg:from-70% 3xl:from-65% lg:from-custom-grey lg:to-custom-green lg:to-70% 3xl:to-65% xs:to-custom-grey">
        <section className="grid grid-cols-3 lg:grid-cols-5 xl:container mx-auto">
          ...
          <div className="md:py-20 py-5 text-center lg:text-start px-5 lg:px-0 bg-custom-white lg:bg-custom-grey">
            <h2 className="text-xl md:text-3xl lg:text-5xl font-bold md:p-0 pt-5">Search, Find, & Apply</h2>
            ...
            <div className="flex justify-between bg-white rounded-xl lg:p-5 p-3 shadow-md lg:gap-4 gap-2 lg:mb-20 mb-16 lg:text-sm text-[8px]">
      ...
      <div className="flex justify-between lg:pt-40 pt-24 gap-5 lg:px-24 px-5 xl:container mx-auto">
        ...
        <div className="hidden lg:flex">
          <button className="md:text-xl text-xs font-bold text-custom-green border-2 border-custom-green rounded-md px-5 py-2 my-16 hover:bg-custom-green hover:text-white">Learn More</button>
        </div>
      </div>


      <div className="grid lg:grid-cols-4 xs:grid-cols-2 md:gap-8 gap-3 lg:px-20 px-5 py-8 xl:container mx-auto">
        ...
        <div className=" bg-white rounded-xl md:p-8 p-4">
          ...
          <div className="md:text-xl text-sm font-bold md:my-5 my-1">Create a Resume</div>
          <div className="md:text-xs text-[8px] text-custom-text-grey">Lorem ipsum dolor sit amet consectetur adipisicing elit. Lorem ipsum dolor sit amet consectetur.</div>
        </div>
        <div className=" bg-white rounded-xl md:p-8 p-4">
          <img src='findJob.png' className='md:w-auto w-8'></img>
          <div className="md:text-xl text-sm font-bold md:my-5 my-1">Find Job</div>
          <div className="md:text-xs text-[8px] text-custom-text-grey">Lorem ipsum dolor sit amet consectetur adipisicing elit. Lorem ipsum dolor sit amet consectetur.</div>
        </div>
        <div className=" bg-white rounded-xl md:p-8 p-4">
          <img src='applyJob.png' className='md:w-auto w-8'></img>
          <div className="md:text-xl text-sm font-bold md:my-5 my-1">Apply Job</div>
          <div className="md:text-xs text-[8px] text-custom-text-grey">Lorem ipsum dolor sit amet consectetur adipisicing elit. Lorem ipsum dolor sit amet consectetur.</div>
        </div>
      </div>
      <div>
        <button className="md:text-xl text-xs font-bold text-custom-green border-2 border-custom-green rounded-md px-5 py-2 hover:bg-custom-green hover:text-white lg:hidden mx-auto block">Learn More</button>
      </div>



      <div className="lg:px-24 px-5 grid lg:grid-cols-2 grid-cols-1 md:py-32 py-16 lg:gap-20 xl:container mx-auto">
        ...
        <div className='lg:text-start text-center my-auto'>
          ...
          <button className="md:text-xl text-xs font-bold text-custom-green border-2 border-custom-green rounded-md px-5 py-2 mt-6 lg:mx-0 mx-auto hover:bg-custom-green hover:text-white block">Learn More</button>
        </div>
      </div>

      <div className='bg-custom-green bg-opacity-5'>
        <div className="lg:py-32 py-5 xl:container mx-auto">
          ...
          <div className="swiper-container lg:ml-24 ml-5">
            ...
            >
              <SwiperSlide>
              <div className="bg-white rounded-xl md:p-10 p-4 min-h-full group hover:bg-custom-green relative">
                <img src='design&Developement.png' className=" md:w-auto w-8 group-hover:brightness-0 group-hover:invert"></img>
                <h3 className="md:text-xl text-xs font-bold md:my-5 my-2 group-hover:text-white">Design and Development</h3>
              ...
              <div className="bg-white rounded-xl md:p-10 p-4  min-h-full group hover:bg-custom-green relative">
                ...
                <h3 className="md:text-xl text-xs font-bold md:my-5 my-2 group-hover:text-white">Accounting and Finance</h3>
                <p className="md:text-xs text-[8px] text-custom-text-grey group-hover:text-white absolute md:left-10 left-5 bottom-4">350 Job Vacancy</p>
              </div>
              </SwiperSlide>
              <SwiperSlide>
              <div className="bg-white rounded-xl md:p-10 p-4 min-h-full group hover:bg-custom-green relative">
                ...
                <h3 className="md:text-xl text-xs font-bold md:my-5 my-2 group-hover:text-white">Bank institution</h3>
                <p className="md:text-xs text-[8px] text-custom-text-grey group-hover:text-white absolute md:left-10 left-5 bottom-4">350 Job Vacancy</p>
              </div>
              </SwiperSlide>
              <SwiperSlide>
              <div className="bg-white rounded-xl md:p-10 p-4 min-h-full group hover:bg-custom-green relative">
                ...
                <h3 className="md:text-xl text-xs font-bold md:my-5 my-2 group-hover:text-white">Product Management</h3>
                <p className="md:text-xs text-[8px] text-custom-text-grey group-hover:text-white absolute md:left-10 left-5 bottom-4">350 Job Vacancy</p>
              </div>
              </SwiperSlide>
              <SwiperSlide>
              <div className="bg-white rounded-xl md:p-10 p-4 min-h-full group hover:bg-custom-green relative">
                ...
                <h3 className="md:text-xl text-xs font-bold md:my-5 my-2 group-hover:text-white">Customer Support</h3>
                <p className="md:text-xs text-[8px] text-custom-text-grey group-hover:text-white absolute md:left-10 left-5 bottom-4">350 Job Vacancy</p>
              </div>
              </SwiperSlide>
            </Swiper>
          ...
          <button className="md:text-xl text-xs font-bold text-custom-green border-2 border-custom-green rounded-md px-5 py-2 mt-10 hover:bg-custom-green hover:text-white block mx-auto">View More</button>
      ...
      <div className="lg:py-32 py-16 xl:container mx-auto">
        ...
        <div className="swiper-container lg:ml-24 ml-5">
          ...
          >
            <SwiperSlide>
            <div className="bg-white rounded-xl md:p-10 p-4 min-h-full relative">
              <img src='uxUI.png' className='md:w-auto w-16'></img>
              <h3 className="md:text-xl text-sm font-bold md:my-5 my-2 ">UI/UX Designer</h3>
              ...
              <a href='#' className='absolute md:bottom-10 md:left-10 bottom-4 left-4 text-custom-green hover:text-black md:text-xl text-sm font-bold'>Apply Now {'>'}</a>
            </div>
            </SwiperSlide>
            <SwiperSlide>
            <div className="bg-white rounded-xl md:p-10 p-4 min-h-full relative">
              <img src='fullStack.png' className='md:w-auto w-16'></img>
              <h3 className="md:text-xl text-sm font-bold md:my-5 my-2 ">Full Stack Developer</h3>
            ...
            <div className="bg-white rounded-xl md:p-10 p-4 min-h-full relative">
              ...
              <h3 className="md:text-xl text-sm font-bold md:my-5 my-2">Product Designer</h3>
      ...
      <div className="lg:px-24 px-5 lg:mb-40 mb-20 xl:container mx-auto">
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-20 gap-5 my-5">
          <div>
            ...
            <div className=" lg:block hidden">
              <p className=' text-xl text-center lg:text-start mt-10 mb-2 font-bold'>Brown Gracia</p>
          ...
          <div className="bg-custom-green rounded-xl h-full p-36"></div>
          <div className=" lg:hidden">
              <p className=' md:text-xl text:md text-center lg:text-start font-bold'>Brown Gracia</p>
              <p className='md:text-xs text-[8px] text-custom-text-grey text-center lg:text-start'>Full Stack Developer in XReact Tech</p>
      ...
      <div className="bg-gradient-to-b from-50% from-transparent to-50% to-custom-green text-white lg:px-24 px-5">
        <div className='bg-custom-dark-green rounded-xl h-full flex flex-col items-center md:py-10 py-5 xl:container mx-auto'>
      ...
      <div className='bg-custom-green'>
        <div className='lg:px-24 px-5 grid lg:grid-cols-5 grid-cols-2 text-white lg:gap-32 gap-5 py-16 xl:container mx-auto'>
